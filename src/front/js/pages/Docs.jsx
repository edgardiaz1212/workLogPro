...
function Docs() {
    //    aca el list debe llamar a los nombes de los documentos de la base de datos para listarlo. esto sera segun el tipo de documento que se selecciono en el dropbox
      ...
      <div className="offcanvas-body">
        ...
        <form className="d-flex mt-3" role="search">
          ...
          <button className="btn btn-outline-success" type="submit">Search</button>
            ...
            <div className="container m-3 list-group">
